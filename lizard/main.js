...
lizard.main = {
	...
	loadAndCreateAssets : function()
	{
		...
		jsonLoader.load("objects/rock_obj.js", function(geometry){
			Resources.addGeometry("rock", geometry);
		});
		
		jsonLoader.load("objects/lizardeye_obj.js", function(geometry){
			Resources.addGeometry("lizardeye", geometry);
		});
		
		jsonLoader.load("objects/ground_obj.js", function(geometry){
			Resources.addGeometry("ground", geometry);
		});	
	
		// Textures ------------------------------------------------
		var lizard_diffuse		= new THREE.ImageUtils.loadTexture("textures/lizard_diffuse.png");
		var lizard_normal		= new THREE.ImageUtils.loadTexture("textures/lizard_normal.png");
		var lizard_specular		= new THREE.ImageUtils.loadTexture("textures/lizard_specular.png");
		var lizard_emissive		= new THREE.ImageUtils.loadTexture("textures/lizard_emissive.png");
		var lizardeye_diffuse	= new THREE.ImageUtils.loadTexture("textures/lizardeye_diffuse.png");
		var lizardeye_emissive	= new THREE.ImageUtils.loadTexture("textures/lizardeye_emissive.png");
		var rock_diffuse		= new THREE.ImageUtils.loadTexture("textures/rock_diffuse.png");
		var rock_normal			= new THREE.ImageUtils.loadTexture("textures/rock_normal.png");
		var rock_specular		= new THREE.ImageUtils.loadTexture("textures/rock_specular.png");
		var ground_diffuse		= new THREE.ImageUtils.loadTexture("textures/ground_diffuse.png");
		var ground_normal		= new THREE.ImageUtils.loadTexture("textures/ground_normal.png");
		...
		jsonLoader.load("objects/lizard_obj.js", function(geometry){
	...
	createWorld : function()
	{
		...
		this.scene.add(lizardOBJ);
		this.scene.add(lizardEyeOBJ);
